...
#开始下载 ubuntu24.04
Invoke-WebRequest -Uri https://wslstorestorage.blob.core.windows.net/wslblob/Ubuntu2404-240425.AppxBundle -OutFile Ubuntu24.04.appx -UseBasicParsing
...
* [知乎-win10离线安装wsl2](https://zhuanlan.zhihu.com/p/23836826798)
